...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objetoRetornado = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 15}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    assert.deepStrictEqual(objetoRetornado.fetchMenu, { food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 15}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sopa", "sashimi", 'coxinha', 'agua']);
    // Agora faça o TESTE 8 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 8: Verifique que, ao chamar `objetoRetornado.pay()`, retorna-se a soma dos preços de tudo que foi pedido, conforme registrado em `objetoRetornado.consumption`
    // ```
    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos
    assert.strictEqual(objetoRetornado.pay(), 44.550000000000004);
